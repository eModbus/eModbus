...
ModbusServerRTU::ModbusServerRTU(uint32_t timeout, int rtsPin) : ModbusServer(),
                                                                 serverTask(nullptr),
...
ModbusServerRTU::ModbusServerRTU(uint32_t timeout, RTScallback rts) : ModbusServer(),
                                                                      serverTask(nullptr),
                                                                      serverTimeout(timeout),
                                                                      MSRserial(nullptr),
                                                                      MSRinterval(2000), // will be calculated in begin()!
...
// Start task to handle the client
  ...
  xTaskCreate((TaskFunction_t)&serve, taskName, SERVER_TASK_STACK, this, 8, &serverTask);
