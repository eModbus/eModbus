...
Error ModbusClientTCPasync::addRequest(uint8_t serverID, uint8_t functionCode, uint32_t token) {
  Error rc = SUCCESS;        // Return value

  // Create request, if valid
  TCPRequest *r = TCPRequest::createTCPRequest(rc, MTA_target, serverID, functionCode, token);
...
vector<uint8_t> ModbusClientTCPasync::generateRequest(uint16_t transactionID, uint8_t serverID, uint8_t functionCode) {
...
Error ModbusClientTCPasync::addRequest(uint8_t serverID, uint8_t functionCode, uint16_t p1, uint32_t token) {
  Error rc = SUCCESS;        // Return value

  // Create request, if valid
  TCPRequest *r = TCPRequest::createTCPRequest(rc, MTA_target, serverID, functionCode, p1, token);
...
vector<uint8_t> ModbusClientTCPasync::generateRequest(uint16_t transactionID, uint8_t serverID, uint8_t functionCode, uint16_t p1) {
  Error rc = SUCCESS;       // Return code from generating the request
  vector<uint8_t> rv;       // Returned std::vector with the message or error code
  TargetHost dummyHost = { IPAddress(1, 1, 1, 1), 99, 0, 0 };
...
Error ModbusClientTCPasync::addRequest(uint8_t serverID, uint8_t functionCode, uint16_t p1, uint16_t p2, uint32_t token) {
  Error rc = SUCCESS;        // Return value

  // Create request, if valid
  TCPRequest *r = TCPRequest::createTCPRequest(rc, MTA_target, serverID, functionCode, p1, p2, token);
...
vector<uint8_t> ModbusClientTCPasync::generateRequest(uint16_t transactionID, uint8_t serverID, uint8_t functionCode, uint16_t p1, uint16_t p2) {
  Error rc = SUCCESS;       // Return code from generating the request
  vector<uint8_t> rv;       // Returned std::vector with the message or error code
  TargetHost dummyHost = { IPAddress(1, 1, 1, 1), 99, 0, 0 };
...
Error ModbusClientTCPasync::addRequest(uint8_t serverID, uint8_t functionCode, uint16_t p1, uint16_t p2, uint16_t p3, uint32_t token) {
  Error rc = SUCCESS;        // Return value

  // Create request, if valid
  TCPRequest *r = TCPRequest::createTCPRequest(rc, MTA_target, serverID, functionCode, p1, p2, p3, token);
...
vector<uint8_t> ModbusClientTCPasync::generateRequest(uint16_t transactionID, uint8_t serverID, uint8_t functionCode, uint16_t p1, uint16_t p2, uint16_t p3) {
  Error rc = SUCCESS;       // Return code from generating the request
  vector<uint8_t> rv;       // Returned std::vector with the message or error code
  TargetHost dummyHost = { IPAddress(1, 1, 1, 1), 99, 0, 0 };
...
Error ModbusClientTCPasync::addRequest(uint8_t serverID, uint8_t functionCode, uint16_t p1, uint16_t p2, uint8_t count, uint16_t *arrayOfWords, uint32_t token) {
  Error rc = SUCCESS;        // Return value

  // Create request, if valid
  TCPRequest *r = TCPRequest::createTCPRequest(rc, MTA_target, serverID, functionCode, p1, p2, count, arrayOfWords, token);
...
vector<uint8_t> ModbusClientTCPasync::generateRequest(uint16_t transactionID, uint8_t serverID, uint8_t functionCode, uint16_t p1, uint16_t p2, uint8_t count, uint16_t *arrayOfWords) {
  Error rc = SUCCESS;       // Return code from generating the request
  vector<uint8_t> rv;       // Returned std::vector with the message or error code
  TargetHost dummyHost = { IPAddress(1, 1, 1, 1), 99, 0, 0 };
...
Error ModbusClientTCPasync::addRequest(uint8_t serverID, uint8_t functionCode, uint16_t p1, uint16_t p2, uint8_t count, uint8_t *arrayOfBytes, uint32_t token) {
  Error rc = SUCCESS;        // Return value

  // Create request, if valid
  TCPRequest *r = TCPRequest::createTCPRequest(rc, MTA_target, serverID, functionCode, p1, p2, count, arrayOfBytes, token);
...
vector<uint8_t> ModbusClientTCPasync::generateRequest(uint16_t transactionID, uint8_t serverID, uint8_t functionCode, uint16_t p1, uint16_t p2, uint8_t count, uint8_t *arrayOfBytes) {
  Error rc = SUCCESS;       // Return code from generating the request
  vector<uint8_t> rv;       // Returned std::vector with the message or error code
  TargetHost dummyHost = { IPAddress(1, 1, 1, 1), 99, 0, 0 };
...
Error ModbusClientTCPasync::addRequest(uint8_t serverID, uint8_t functionCode, uint16_t count, uint8_t *arrayOfBytes, uint32_t token) {
  Error rc = SUCCESS;        // Return value

  // Create request, if valid
  TCPRequest *r = TCPRequest::createTCPRequest(rc, MTA_target, serverID, functionCode, count, arrayOfBytes, token);
...
vector<uint8_t> ModbusClientTCPasync::generateRequest(uint16_t transactionID, uint8_t serverID, uint8_t functionCode, uint16_t count, uint8_t *arrayOfBytes) {
  Error rc = SUCCESS;       // Return code from generating the request
  vector<uint8_t> rv;       // Returned std::vector with the message or error code
  TargetHost dummyHost = { IPAddress(1, 1, 1, 1), 99, 0, 0 };
